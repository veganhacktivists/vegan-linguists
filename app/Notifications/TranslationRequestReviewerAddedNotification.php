...
class TranslationRequestReviewerAddedNotification
    ...
    implements ShouldQueue
{
    ...
    {
        return __(
            'Get notified when someone starts reviewing a translation request'
        );
    }
    ...
    public function toMail(User $notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->line(
                __(
                    ':userName has started reviewing the :languageName translation for :sourceTitle.',
                    [
