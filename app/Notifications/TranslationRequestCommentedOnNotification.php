...
class TranslationRequestCommentedOnNotification
    ...
    implements ShouldQueue
{
    ...
    public function toMail(User $notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->line(
                __(
                    ':userName has left a comment on the :languageName translation for :sourceTitle.',
                    [
            ...
            ->action(__('View translation request'), $route);
    }
