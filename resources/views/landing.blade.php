                ...
                <div
                    ...
                    <div class="flex items-center justify-end md:flex-1 lg:w-0">
                        ...
                        <a href="{{ route('register') }}"
                           class="ml-4 sm:ml-8 whitespace-nowrap inline-flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white hover:from-purple-700 hover:to-indigo-700">
                            {{ __('Sign up') }}
                        </a>
                    </div>
                </div>
        ...
        <main>
                    ...
                    <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                        ...
                        <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                            <h1 class="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                                <span class="block text-white">{{ __('Have vegan content?') }}</span>
                                <span class="block text-indigo-200">{{ __('Get it translated') }}</span>
                            </h1>
                            ...
                            <div class="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                                <div class="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                                    ...
                                    <a href="{{ route('register') }}"
                                       class="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-500 bg-opacity-70 hover:bg-opacity-80 sm:px-8">
                        ...
                        <div
                            ...
                            <div>
                                <div>
                                    <span
                                          class="h-12 w-12 rounded-md flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600">
                                        <x-heroicon-o-translate class="h-6 w-6 text-white" />
                                    </span>
                                </div>
                                <div class="mt-6">
                                    <h2 class="text-3xl font-extrabold tracking-tight text-gray-900">
            ...
            <div class="relative bg-gray-900">
                ...
                <div
                    ...
                    <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
                        ...
                        <p class="mt-3 text-3xl font-extrabold text-white">{{ __('Who are the Vegan Linguists?') }}
                        </p>
            ...
            <div class="bg-white">
                <div
                    ...
                    <h2 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-4xl space-y-2">
                        <span class="block">{{ __('Ready to get started?') }}</span>

                        <span
                              class="bg-gradient-to-r from-purple-600 to-indigo-600 text-white inline-block p-2 -ml-2 -mr-2">
                            {{ __('Create an account and submit your content.') }}
                        </span>

                        <span
                              class="text-2xl block bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">
                            {{ __('(Or start translating the content of others!)') }}
                        </span>
                    </h2>
