...
<x-page-container>
    ...
    <div class="sm:mx-4">
        ...
        @if ($translationRequests->count() > 0)
            <x-panel>
                <x-dashboard.translation-request-list :translationRequests="$translationRequests"
                                                      :displayStatus="$this->isMinePage() || $this->isCompletedPage()"
                                                      :displayPriority="$this->isAvailablePage()">
