...
<body class="font-sans bg-gray-100 antialiased">
    ...
    @livewireScripts
    <script src="{{ mix('js/livewire-turbolinks.js') }}" data-turbolinks-eval="false"></script>
</body>
