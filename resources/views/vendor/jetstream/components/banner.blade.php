...
<div x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}"
     :class="{ 'bg-brand-green-400': style == 'success', 'bg-red-700': style == 'danger' }"
     style="display: none;"
     x-show="show && message"
     x-init="
        ...
        <div class="flex items-center justify-between flex-wrap">
            ...
            <div class="flex-shrink-0 sm:ml-3">
                <button type="button"
                        ...
                        :class="{ 'hover:bg-brand-green-500 focus:bg-brand-green-500': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger' }"
                        aria-label="Dismiss"
