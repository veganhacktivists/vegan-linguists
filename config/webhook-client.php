...
use App\Actions\Newsletter\ValidateMailchimpWebhook;
use App\Jobs\ProcessMailchimpWebhook;
...
return [
    'configs' => [
        [
             ...
             */
            'signature_validator' => ValidateMailchimpWebhook::class,
             ...
             */
            'process_webhook_job' => ProcessMailchimpWebhook::class,
        ],
    ],
];
